...
SECRET_KEY = 'django-insecure-+9cci%(ea)7bepf^!x^(3l541+%w%2#3&yspck72_u_%_#btff'
...
DATABASES = { 'default': { 'ENGINE': 'django.db.backends.postgresql_psycopg2', 'NAME': 'dbproductos', 
